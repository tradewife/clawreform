...
pub struct ChannelUser {
    ...
    /// Optional mapping to an ClawReform user identity.
    pub clawreform_user: Option<String>,
}
...
// Re-export policy/format types from clawreform-types for convenience.
pub use clawreform_types::config::{DmPolicy, GroupPolicy, OutputFormat};

/// Trait that every channel adapter must implement.
///
/// A channel adapter bridges a messaging platform to the ClawReform kernel by converting
