...
pub struct AgentRouter {
    /// Default agent per user (keyed by clawreform_user or platform_id).
...
mod tests {
    ...
    fn test_binding_channel_match() {
        ...
        router.load_bindings(&[AgentBinding {
            ...
            match_rule: clawreform_types::config::BindingMatchRule {
    ...
    fn test_binding_specificity_scores() {
        use clawreform_types::config::BindingMatchRule;
