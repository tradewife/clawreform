// ClawReform Visual Workflow Builder — Drag-and-drop workflow designer
'use strict';
...
function workflowBuilder() {
  return {
    ...
    async init() {
      ...
      try {
        var list = await ClawReformAPI.get('/api/agents');
    ...
    async saveWorkflow() {
      ...
      try {
        await ClawReformAPI.post('/api/workflows', {
          name: this.workflowName || 'untitled',
          description: this.workflowDescription || '',
          steps: steps
        });
        ClawReformToast.success('Workflow saved!');
