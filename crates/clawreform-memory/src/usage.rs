...
impl UsageStore {
    ...
    pub fn record(&self, record: &UsageRecord) -> ClawReformResult<()> {
        let conn = self
            .conn
            .lock()
    ...
    pub fn query_hourly(&self, agent_id: AgentId) -> ClawReformResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn query_daily(&self, agent_id: AgentId) -> ClawReformResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn query_monthly(&self, agent_id: AgentId) -> ClawReformResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn query_global_hourly(&self) -> ClawReformResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn query_global_monthly(&self) -> ClawReformResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn query_summary(&self, agent_id: Option<AgentId>) -> ClawReformResult<UsageSummary> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn query_by_model(&self) -> ClawReformResult<Vec<ModelUsage>> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
        ...
        for row in rows {
            results.push(row.map_err(|e| ClawReformError::Memory(e.to_string()))?);
        }
        Ok(results)
    }

    /// Query daily usage breakdown for the last N days.
    pub fn query_daily_breakdown(&self, days: u32) -> ClawReformResult<Vec<DailyBreakdown>> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn query_first_event_date(&self) -> ClawReformResult<Option<String>> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn query_today_cost(&self) -> ClawReformResult<f64> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
    ...
    pub fn cleanup_old(&self, days: u32) -> ClawReformResult<usize> {
        let conn = self
            .conn
            .lock()
            .map_err(|e| ClawReformError::Internal(e.to_string()))?;
