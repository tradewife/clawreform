...
Usage:
    ...
    from clawreform_client import ClawReform

    client = ClawReform("http://localhost:3000")
...
class ClawReformError(Exception):
...
class _Resource:
    def __init__(self, client: "ClawReform"):
        self._c = client
...
class ClawReform:
    ...
    def _request(self, method: str, path: str, body: Any = None) -> Any:
        ...
        try:
            ...
            raise ClawReformError(f"HTTP {e.code}: {body_text}", e.code, body_text) from e
