...
use clawreform_channels::discord::DiscordAdapter;
use clawreform_channels::email::EmailAdapter;
use clawreform_channels::google_chat::GoogleChatAdapter;
use clawreform_channels::irc::IrcAdapter;
use clawreform_channels::matrix::MatrixAdapter;
use clawreform_channels::mattermost::MattermostAdapter;
use clawreform_channels::rocketchat::RocketChatAdapter;
use clawreform_channels::router::AgentRouter;
use clawreform_channels::signal::SignalAdapter;
use clawreform_channels::slack::SlackAdapter;
use clawreform_channels::teams::TeamsAdapter;
use clawreform_channels::telegram::TelegramAdapter;
use clawreform_channels::twitch::TwitchAdapter;
use clawreform_channels::types::ChannelAdapter;
use clawreform_channels::whatsapp::WhatsAppAdapter;
use clawreform_channels::xmpp::XmppAdapter;
use clawreform_channels::zulip::ZulipAdapter;
// Wave 3
use clawreform_channels::bluesky::BlueskyAdapter;
use clawreform_channels::feishu::FeishuAdapter;
use clawreform_channels::line::LineAdapter;
use clawreform_channels::mastodon::MastodonAdapter;
use clawreform_channels::messenger::MessengerAdapter;
use clawreform_channels::reddit::RedditAdapter;
use clawreform_channels::revolt::RevoltAdapter;
use clawreform_channels::viber::ViberAdapter;
// Wave 4
use clawreform_channels::flock::FlockAdapter;
use clawreform_channels::guilded::GuildedAdapter;
use clawreform_channels::keybase::KeybaseAdapter;
use clawreform_channels::nextcloud::NextcloudAdapter;
use clawreform_channels::nostr::NostrAdapter;
use clawreform_channels::pumble::PumbleAdapter;
use clawreform_channels::threema::ThreemaAdapter;
use clawreform_channels::twist::TwistAdapter;
use clawreform_channels::webex::WebexAdapter;
// Wave 5
use async_trait::async_trait;
use clawreform_channels::dingtalk::DingTalkAdapter;
use clawreform_channels::discourse::DiscourseAdapter;
use clawreform_channels::gitter::GitterAdapter;
use clawreform_channels::gotify::GotifyAdapter;
use clawreform_channels::linkedin::LinkedInAdapter;
use clawreform_channels::mumble::MumbleAdapter;
use clawreform_channels::ntfy::NtfyAdapter;
use clawreform_channels::webhook::WebhookAdapter;
...
impl ChannelBridgeHandle for KernelBridgeAdapter {
    ...
    async fn uptime_info(&self) -> String {
        ...
        if hours > 0 {
            format!(
                "ClawReform status: {}h {}m uptime, {} agent(s)",
                hours,
                mins,
                agents.len()
            )
            ...
            format!(
                "ClawReform status: {}m uptime, {} agent(s)",
                mins,
                agents.len()
            )
        }
...
pub async fn start_channel_bridge_with_config(
    kernel: Arc<ClawReformKernel>,
    config: &clawreform_types::config::ChannelsConfig,
