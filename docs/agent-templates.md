...
clawreform spawn --template agents/writer/agent.toml
```
...
```bash
clawreform spawn code-reviewer
...
```bash
clawreform spawn data-scientist
...
```bash
clawreform spawn legal-assistant
...
```bash
clawreform spawn email-assistant
...
```bash
clawreform spawn customer-support
...
```bash
clawreform spawn sales-assistant
...
```bash
clawreform spawn meeting-assistant
...
```bash
clawreform spawn health-tracker
...
```bash
clawreform spawn personal-finance
...
```bash
clawreform spawn travel-planner
...
```bash
clawreform spawn home-automation
