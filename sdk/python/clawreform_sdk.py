"""
ClawReform Python SDK — helper library for writing Python agents.
...
def read_input() -> Dict[str, Any]:
    """Read the input JSON from stdin (sent by the ClawReform kernel)."""
...
def respond(text: str, metadata: Optional[Dict[str, Any]] = None) -> None:
    """Send a response back to the ClawReform kernel via stdout."""
...
def log(message: str, level: str = "info") -> None:
    """Log a message to stderr (visible in ClawReform daemon logs)."""
