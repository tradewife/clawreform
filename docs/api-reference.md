  ...
  "templates": [
    {
      "name": "hello-world",
      "description": "A friendly greeting agent",
      "path": "/home/user/.clawreform/agents/hello-world/agent.toml"
    },
    {
      "name": "coder",
      "description": "Expert coding assistant",
      "path": "/home/user/.clawreform/agents/coder/agent.toml"
    }
  ],
  "total": 30
}
...
```json
{
  "status": "created",
  "skill": "my-skill",
  "path": "/home/user/.clawreform/skills/my-skill"
}
```
...
|--------|---------|----------|
| `clawreform:<name>` | `clawreform:coder` | Find agent by name |
