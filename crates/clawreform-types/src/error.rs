//! Shared error types for the ClawReform system.

use thiserror::Error;

/// Top-level error type for the ClawReform system.
#[derive(Error, Debug)]
pub enum ClawReformError {
...
/// Alias for Result with ClawReformError.
pub type ClawReformResult<T> = Result<T, ClawReformError>;
