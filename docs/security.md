...
|---|--------|-------|------------------|
| 1 | Capability-Based Security | `clawreform-types` | Unauthorized actions by agents |
| 2 | WASM Dual Metering | `clawreform-runtime` | Infinite loops, CPU DoS |
| 3 | Merkle Audit Trail | `clawreform-runtime` | Tampered audit logs |
| 4 | Taint Tracking | `clawreform-types` | Prompt injection, data exfiltration |
| 5 | Ed25519 Manifest Signing | `clawreform-types` | Supply chain attacks |
| 6 | SSRF Protection | `clawreform-runtime` | Server-Side Request Forgery |
| 7 | Secret Zeroization | `clawreform-runtime`, `clawreform-channels` | Memory forensics, key leakage |
| 8 | OFP Mutual Auth | `clawreform-wire` | Unauthorized peer connections |
| 9 | Security Headers | `clawreform-api` | XSS, clickjacking, MIME sniffing |
| 10 | GCRA Rate Limiter | `clawreform-api` | API abuse, denial of service |
| 11 | Path Traversal Prevention | `clawreform-runtime` | Directory traversal attacks |
| 12 | Subprocess Sandbox | `clawreform-runtime` | Secret leakage via child processes |
| 13 | Prompt Injection Scanner | `clawreform-skills` | Malicious skill prompts |
| 14 | Loop Guard | `clawreform-runtime` | Stuck agent tool loops |
| 15 | Session Repair | `clawreform-runtime` | Corrupted LLM conversation history |
| 16 | Health Endpoint Redaction | `clawreform-api` | Information leakage |
...
**Source:** `clawreform-runtime/src/sandbox.rs`
...
**Source:** `clawreform-runtime/src/audit.rs`
...
**Source:** `clawreform-types/src/manifest_signing.rs`
...
**Source:** `clawreform-runtime/src/host_functions.rs`
...
**LLM Drivers** (`clawreform-runtime/src/drivers/`):
...
**Channel Adapters** (`clawreform-channels/src/`):
...
**Web Search** (`clawreform-runtime/src/web_search.rs`):
...
**Embedding** (`clawreform-runtime/src/embedding.rs`):
...
**Source:** `clawreform-api/src/middleware.rs`
...
**Source:** `clawreform-runtime/src/subprocess_sandbox.rs`
...
**Source:** `clawreform-skills/src/verify.rs`
...
**Source:** `clawreform-runtime/src/loop_guard.rs`
...
**Source:** `clawreform-runtime/src/session_repair.rs`
